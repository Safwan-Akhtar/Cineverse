...
public class Seltestfelix {
	...
	public static void beforeClass() {
		...
		report.addSystemInfo("Host Name", "QA").addSystemInfo("Tester", "Felix");
		report.loadConfig(new File("extent-report.xml"));
	}
...
//        opts.setHeadless(true);
	...
	public void navToClassPage() throws InterruptedException, IOException {
		...
		test.log(LogStatus.INFO,
				"Unique element on Classification page exists, meaning the classification page was accessed.");
		sleep(2000);
	...
	public void navToComingHere() throws InterruptedException, IOException {
		...
		test.log(LogStatus.INFO,
				"Unique element from the 'getting here' page exists, meaning the classification page was accessed.");
		sleep(2000);
		File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
	...
	public void navToGallarySearch() throws InterruptedException, IOException {
		...
		test.log(LogStatus.INFO,
				"Unique element from the search gallary page exists, meaning the search gallary page was accessed.");
		sleep(2000);
		...
		test.log(LogStatus.INFO,
				"Unique element on the 'getting here' page exists, meaning the classification page was accessed.");
		File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
